            ...
            <div class="row g-5">
                <main class="main col-lg-7 col-xl-8 mb-5 mb-lg-0">
                    ...
                    <div class="single_post_view">
                        ...
                        <div class="row g-4">
                            <?php
                                $related_post_query = mysqli_query($conn, "SELECT `title`, `slug`, `description`, `image`, `created_at`, `category`, `code_file` FROM `project_posts` WHERE status = '1' AND `category` = '$category' AND `slug` != '$slug' ORDER BY id DESC");
                                    ...
                                    <div class="blog_content p-4 col-8">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <a class="fs-5 text-capitalize mb-3"
                                                ...
                                                <?= $related_post_result['category'] ?>
                                            </a>

                                            <h5>
                                                <?php
                                                            $timestamp =  $related_post_result['created_at'];
                                                            $date = date("M d, Y", strtotime($timestamp));
                                                            echo $date;
                                                            ?>
                                            </h5>
                                        ...
                                        <p>
                                            <?php
                                                        $string = $related_post_result['description'];
                                                        if (strlen($string) > 80) {
                                        ...
                                        <div class="comment_download_counter text-end mt-4">
                                            ...
                                            <?php
                                                        if (!empty($related_post_result['code_file'])) {
                                                            if (isset($_SESSION['auth_user'])) {
                                                        ?>
                                            ...
                                            <a download="<?= $related_post_result['code_file'] ?>"
                                                href="assets/files/<?= $related_post_result['code_file'] ?>"
